...
dir<-"figures_TMapping_ordered_LampreyRef_cutoff50"
...
ggsave(file="classifier's_prediction_UsePCutoff0_UseDiagonal.pdf", width=9 , height=8)

save(X, file="X_UsePCutoff0_UseDiagonal.cutoff30.rda")
