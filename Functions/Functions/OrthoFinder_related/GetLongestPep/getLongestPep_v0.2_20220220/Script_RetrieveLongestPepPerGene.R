...
# The function retrieve the pep id info and the gene id info
# The function merge the info together
# The function get the longest transcript id
# The function write the longest peptides with the gene lock ID to a new file

# Read the files 
# 


# This script convert the XP id to Loc id
#
library(dplyr)
library(seqinr)
library(stringr)
