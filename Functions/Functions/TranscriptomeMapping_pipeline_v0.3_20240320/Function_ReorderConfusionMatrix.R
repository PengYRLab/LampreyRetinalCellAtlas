...
#' @description This function reorder the rows and columns of the confusion matrix, in which the column names are the training labels
#' @param row_scale Scale the confusion matrix by row
#' @param make_diagonal Make the best match lies in the diagonal line
