...
# seu<-subset(seu, idents=c("ChickenvRGC1", "ChickenvRGC2", "ChickendRGC2"))

seu<-subset(seu, idents=c("ChickenvRGC1", "ChickenvRGC2"))

VlnPlot(seu, features = c("nFeature_RNA", "nCount_RNA", "percent.mt"), ncol = 3)

seu<-subset(seu, nFeature_RNA>1000)
...
source("Function_OrthogroupID2GeneSymbol.R")
...
mat<-OrthogroupID2GeneSymbol(mat=mat,
                                  ...
                                  reference_species=c("Lamprey", "Chicken")
                                  )
