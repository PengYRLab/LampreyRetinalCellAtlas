...
tmp[tmp %in% c("BC1A", "BC1B", "BC2", "BC3A", "BC3B", "BC4")]<-"OFF BC"
tmp[tmp %in% c("BC5A", "BC5B", "BC5C", "BC5D", "BC6", "BC7", "BC8-9")]<-"ON BC"
...
seu.rbc<-subset(seu.rbc, downsample=1000)
...
seu<-subset(seu, idents=c("RBC", "BC5A", "BC5D", "BC2", "BC1B","BC1A", "BC3B","BC4"))
...
file<- paste0("Dimplot_subclass_lamprey_Nolgend_width5.5_height5", ".pdf")
...
file<- paste0("Dimplot_subclass_mouse_Nolgend_width5.5_height5", ".pdf")
